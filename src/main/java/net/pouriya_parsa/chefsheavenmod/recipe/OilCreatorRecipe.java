...
public class OilCreatorRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Type implements RecipeType<OilCreatorRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "oil_creating";
    }


    public static class Serializer implements RecipeSerializer<OilCreatorRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(ChefsHeavenMod.MOD_ID, "oil_creating");
