package net.pouriya_parsa.chefsheavenmod.block.entity.client;
...
public class SlicerBoardBER implements BlockEntityRenderer<SlicerBoardBlockEntity> {

    public SlicerBoardBER(BlockEntityRendererProvider.Context context) {

    }
    @Override
    public void render(SlicerBoardBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
