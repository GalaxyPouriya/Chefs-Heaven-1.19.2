...
public class ModFoods {
    ...
    public static final FoodProperties BEEF_HAM = (new FoodProperties.Builder().nutrition(7).saturationMod(0.3F).build());
    public static final FoodProperties CHICKEN_HAM = (new FoodProperties.Builder().nutrition(6).saturationMod(0.2F).build());
    public static final FoodProperties PORK_HAM = (new FoodProperties.Builder().nutrition(8).saturationMod(0.5F).build());

    public static final FoodProperties COOKED_BEEF_SAUSAGE = (new FoodProperties.Builder().nutrition(7).saturationMod(0.5F).build());
    ...
    public static final FoodProperties PCOOKED_PORK_SAUSAGE = (new FoodProperties.Builder().nutrition(9).saturationMod(0.7F).build());
